...
enum Scrapyard : Hash
{
	VEHICLE_ALEUTIAN      = RAGE_JOAAT("ALEUTIAN"),
	VEHICLE_ASTEROPE2     = RAGE_JOAAT("ASTEROPE2"),
	VEHICLE_BALLER8       = RAGE_JOAAT("BALLER8"),
	VEHICLE_BENSON2       = RAGE_JOAAT("BENSON2"),
	VEHICLE_BOXVILLE6     = RAGE_JOAAT("BOXVILLE6"),
	VEHICLE_CAVALCADE3    = RAGE_JOAAT("CAVALCADE3"),
	VEHICLE_DOMINATOR9    = RAGE_JOAAT("DOMINATOR9"),
	VEHICLE_DORADO        = RAGE_JOAAT("DORADO"),
	VEHICLE_DRIFTEUROS    = RAGE_JOAAT("DRIFTEUROS"),
	VEHICLE_DRIFTFR36     = RAGE_JOAAT("DRIFTFR36"),
	VEHICLE_DRIFTFUTO     = RAGE_JOAAT("DRIFTFUTO"),
	VEHICLE_DRIFTJESTER   = RAGE_JOAAT("DRIFTJESTER"),
	VEHICLE_DRIFTREMUS    = RAGE_JOAAT("DRIFTREMUS"),
	VEHICLE_DRIFTTAMPA    = RAGE_JOAAT("DRIFTTAMPA"),
	VEHICLE_DRIFTYOSEMITE = RAGE_JOAAT("DRIFTYOSEMITE"),
	VEHICLE_DRIFTZR350    = RAGE_JOAAT("DRIFTZR350"),
	VEHICLE_FR36          = RAGE_JOAAT("FR36"),
	VEHICLE_IMPALER5      = RAGE_JOAAT("IMPALER5"),
	VEHICLE_IMPALER6      = RAGE_JOAAT("IMPALER6"),
	VEHICLE_POLGAUNTLET   = RAGE_JOAAT("POLGAUNTLET"),
	VEHICLE_POLICE5       = RAGE_JOAAT("POLICE5"),
	VEHICLE_TERMINUS      = RAGE_JOAAT("TERMINUS"),
	VEHICLE_TOWTRUCK3     = RAGE_JOAAT("TOWTRUCK3"),
	VEHICLE_TOWTRUCK4     = RAGE_JOAAT("TOWTRUCK4"),
	VEHICLE_TURISMO3      = RAGE_JOAAT("TURISMO3"),
	VEHICLE_VIGERO3       = RAGE_JOAAT("VIGERO3"),
	VEHICLE_VIVANITE      = RAGE_JOAAT("VIVANITE")
};