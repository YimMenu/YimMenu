	...
	void debug::misc()
	{
		if (ImGui::BeginTabItem("DEBUG_TAB_MISC"_T.data()))
		{
			...
			components::button("DEBUG_REMOVE_FROM_BAD_SPORT"_T, [] {
				STATS::STAT_SET_INT(rage::joaat("MPPLY_BADSPORT_MESSAGE"), 0, 1);
				STATS::STAT_SET_INT(rage::joaat("MPPLY_BECAME_BADSPORT_NUM"), 0, 1);
				STATS::STAT_SET_FLOAT(rage::joaat("MPPLY_OVERALL_BADSPORT"), 0, true);
