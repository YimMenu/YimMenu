...
namespace big
{
	pointers::pointers()
	{
		...
		// Can Apply Data
		main_batch.add("CAD", "48 8B C4 48 89 58 08 48 89 68 10 48 89 70 18 48 89 78 20 41 56 48 83 EC 20 4C 8B F2 48 8B E9 BB", [this](memory::handle ptr)
		{
			m_can_apply_data = ptr.as<PVOID>();
		});
