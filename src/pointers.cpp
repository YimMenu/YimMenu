...
namespace big
{
	pointers::pointers()
	{
		...
		main_batch.add("SCREEN_RESOLUTION",
		...
		main_batch.add("RCS/GSTFT/GNOFP/GNO/GSTI",
		...
		// Send Chat Message
		main_batch.add("SCM",
		    "48 83 EC 20 48 8B F9 48 8B CA 45 8A F1",
		    [this](memory::handle ptr)
		    {
		...
		// Presence Data
		socialclub_batch.add("PD",
		    "48 8D 05 ? ? ? ? 48 8B F1 48 89 01 48 8D 99 90 00 00 00",
		    [this](memory::handle ptr)
		    {
