#include "kick_from_interior.hpp"
...
namespace big
{
	CommandAccessLevel kick_from_interior::get_access_level()
	{
		return CommandAccessLevel::AGGRESSIVE;
	}

	void kick_from_interior::execute(player_ptr player, const std::vector<std::uint64_t>& _args, const std::shared_ptr<command_context> ctx)
	{
