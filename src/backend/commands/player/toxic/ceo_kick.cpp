...
namespace big
{
	CommandAccessLevel ceo_kick::get_access_level()
	{
		return CommandAccessLevel::AGGRESSIVE;
	}

	void ceo_kick::execute(player_ptr player, const std::vector<std::uint64_t>& _args, const std::shared_ptr<command_context> ctx)
	{
