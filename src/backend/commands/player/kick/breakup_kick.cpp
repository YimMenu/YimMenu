...
namespace big
{
	CommandAccessLevel breakup_kick::get_access_level()
	{
		return CommandAccessLevel::TOXIC;
	}

	void breakup_kick::execute(player_ptr player, const std::vector<std::uint64_t>& _args, const std::shared_ptr<command_context> ctx)
	{
