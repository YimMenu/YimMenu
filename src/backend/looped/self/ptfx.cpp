...
namespace big
{
	static constexpr PedBones ptfx_ped_bones[5] = {PedBones::SKEL_Head, PedBones::SKEL_L_Hand, PedBones::SKEL_R_Hand, PedBones::SKEL_L_Foot, PedBones::SKEL_R_Foot};

	static constexpr const char* ptfx_vehicle_pos[4] = {"wheel_lf", "wheel_lr", "wheel_rf", "wheel_rr"};

	void ptfx_looped::show_player_ptfx_effect(const char* fx_name, const char* name)
	{
	...
	void ptfx_looped::show_vehicle_ptfx_effect(const char* fx_name, const char* name)
	{
