...
namespace big
{
	class infinite_ammo : looped_command
	{
		...
		virtual void on_tick() override { WEAPON::SET_PED_INFINITE_AMMO(self::ped, TRUE, NULL); }

		virtual void on_disable() override { WEAPON::SET_PED_INFINITE_AMMO(self::ped, FALSE, NULL); }
	};
