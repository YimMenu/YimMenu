...
{	
	...
	bool_command g_aimswat("aimswat", "Aim Swat", "Sets the aimbot to aim at the swat", g.weapons.aimbot.aimswat);
	bool_command g_aimarmy("aimarmy", "Aim Army", "Sets the aimbot to aim at the army", g.weapons.aimbot.aimarmy);
	bool_command g_aimallcops("aimallcops", "Aim All Cop Types", "Sets the aimbot to aim at cops, swat, and army", g.weapons.aimbot.aimallcops);
}
