...
namespace big
{
	class damage_modifier : looped_command
	{
		...
		int damage_modifier_v = g_weapons.damage_modifier_v;
		...
		virtual void on_tick() override
		{
			...
			if (weapon_mgr)
			{
				if (p_modified_weapon != weapon_mgr->m_weapon_info)
				{
					...
					{
						m_hit_limbs_damage_modifier         = p_modified_weapon->m_hit_limbs_damage_modifier;
						m_network_hit_limbs_damage_modifier = p_modified_weapon->m_network_hit_limbs_damage_modifier;
						m_lightly_armoured_damage_modifier  = p_modified_weapon->m_lightly_armoured_damage_modifier;
						m_vehicle_damage_modifier           = p_modified_weapon->m_vehicle_damage_modifier;
						m_max_headshot_distance_player      = p_modified_weapon->m_max_headshot_distance_player;
						m_headshot_damage_modifier_player   = p_modified_weapon->m_headshot_damage_modifier_player;
						m_network_player_damage_modifier    = p_modified_weapon->m_network_player_damage_modifier;
						m_network_ped_damage_modifier       = p_modified_weapon->m_network_ped_damage_modifier;
					}
