...
namespace big
{
	class infinite_mag : looped_command
	{
		...
		virtual void on_tick() override { WEAPON::SET_PED_INFINITE_AMMO_CLIP(self::ped, TRUE); }

		virtual void on_disable() override { WEAPON::SET_PED_INFINITE_AMMO_CLIP(self::ped, FALSE); }
	};
