...
namespace big
{
	void register_script_patches()
	{
		...
		g_script_patcher_service->add_patch({RAGE_JOAAT("respawn_controller"), "2E 00 00 55 00 00 43", 0, {0x00, 0x00, 0x00}, nullptr}); // fix respawn in SP (death)
		g_script_patcher_service->add_patch({RAGE_JOAAT("respawn_controller"), "2E 00 00 55 00 00 43", 0, {0x00, 0x00, 0x00}, nullptr}); // fix respawn in SP (arrest)
