...
namespace lua::native
{
	void init_native_binding(sol::state& L)
	{
		...
		ENTITY.set_function("_GET_LAST_ENTITY_HIT_BY_ENTITY", LUA_NATIVE_ENTITY__GET_LAST_ENTITY_HIT_BY_ENTITY);
		...
		MONEY.set_function("NETWORK_EARN_FROM_ROCKSTAR", LUA_NATIVE_MONEY_NETWORK_EARN_FROM_ROCKSTAR);
		...
		MONEY.set_function("_NETWORK_SPEND_BUY_MFGARAGE", LUA_NATIVE_MONEY__NETWORK_SPEND_BUY_MFGARAGE);
		MONEY.set_function("_NETWORK_SPEND_UPGRADE_MFGARAGE", LUA_NATIVE_MONEY__NETWORK_SPEND_UPGRADE_MFGARAGE);
		MONEY.set_function("_NETWORK_SPEND_BUY_SUPPLIES", LUA_NATIVE_MONEY__NETWORK_SPEND_BUY_SUPPLIES);
		MONEY.set_function("_NETWORK_SPEND_BUY_ACID_LAB", LUA_NATIVE_MONEY__NETWORK_SPEND_BUY_ACID_LAB);
		MONEY.set_function("_NETWORK_SPEND_UPGRADE_ACID_LAB_EQUIPMENT", LUA_NATIVE_MONEY__NETWORK_SPEND_UPGRADE_ACID_LAB_EQUIPMENT);
		MONEY.set_function("_NETWORK_SPEND_UPGRADE_ACID_LAB_ARMOR", LUA_NATIVE_MONEY__NETWORK_SPEND_UPGRADE_ACID_LAB_ARMOR);
		MONEY.set_function("_NETWORK_SPEND_UPGRADE_ACID_LAB_SCOOP", LUA_NATIVE_MONEY__NETWORK_SPEND_UPGRADE_ACID_LAB_SCOOP);
		MONEY.set_function("_NETWORK_SPEND_UPGRADE_ACID_LAB_MINES", LUA_NATIVE_MONEY__NETWORK_SPEND_UPGRADE_ACID_LAB_MINES);
		MONEY.set_function("_NETWORK_SPEND_RENAME_ACID_LAB", LUA_NATIVE_MONEY__NETWORK_SPEND_RENAME_ACID_LAB);
		MONEY.set_function("_NETWORK_SPEND_RENAME_ACID_PRODUCT", LUA_NATIVE_MONEY__NETWORK_SPEND_RENAME_ACID_PRODUCT);
		MONEY.set_function("_NETWORK_EARN_AWARD_JUGGALO_MISSION", LUA_NATIVE_MONEY__NETWORK_EARN_AWARD_JUGGALO_MISSION);
		MONEY.set_function("_NETWORK_EARN_AWARD_ACID_LAB", LUA_NATIVE_MONEY__NETWORK_EARN_AWARD_ACID_LAB);
		MONEY.set_function("_NETWORK_EARN_AWARD_DAILY_STASH", LUA_NATIVE_MONEY__NETWORK_EARN_AWARD_DAILY_STASH);
		MONEY.set_function("_NETWORK_EARN_AWARD_DEAD_DROP", LUA_NATIVE_MONEY__NETWORK_EARN_AWARD_DEAD_DROP);
		MONEY.set_function("_NETWORK_EARN_AWARD_RANDOM_EVENT", LUA_NATIVE_MONEY__NETWORK_EARN_AWARD_RANDOM_EVENT);
		MONEY.set_function("_NETWORK_EARN_AWARD_TAXI", LUA_NATIVE_MONEY__NETWORK_EARN_AWARD_TAXI);
		MONEY.set_function("_NETWORK_EARN_STREET_DEALER", LUA_NATIVE_MONEY__NETWORK_EARN_STREET_DEALER);
		MONEY.set_function("_NETWORK_EARN_SELL_ACID", LUA_NATIVE_MONEY__NETWORK_EARN_SELL_ACID);
		MONEY.set_function("_NETWORK_EARN_SETUP_PARTICIPATION_ACID_LAB", LUA_NATIVE_MONEY__NETWORK_EARN_SETUP_PARTICIPATION_ACID_LAB);
		MONEY.set_function("_NETWORK_EARN_SOURCE_PARTICIPATION_ACID_LAB", LUA_NATIVE_MONEY__NETWORK_EARN_SOURCE_PARTICIPATION_ACID_LAB);
		MONEY.set_function("_NETWORK_EARN_SELL_PARTICIPATION_ACID_LAB", LUA_NATIVE_MONEY__NETWORK_EARN_SELL_PARTICIPATION_ACID_LAB);
		MONEY.set_function("_NETWORK_EARN_JUGGALO_STORY_MISSION", LUA_NATIVE_MONEY__NETWORK_EARN_JUGGALO_STORY_MISSION);
		MONEY.set_function("_NETWORK_EARN_JUGGALO_STORY_MISSION_PARTICIPATION", LUA_NATIVE_MONEY__NETWORK_EARN_JUGGALO_STORY_MISSION_PARTICIPATION);
		MONEY.set_function("_NETWORK_EARN_FOOLIGAN_JOB", LUA_NATIVE_MONEY__NETWORK_EARN_FOOLIGAN_JOB);
		MONEY.set_function("_NETWORK_EARN_FOOLIGAN_JOB_PARTICIPATION", LUA_NATIVE_MONEY__NETWORK_EARN_FOOLIGAN_JOB_PARTICIPATION);
		MONEY.set_function("_NETWORK_EARN_TAXI_JOB", LUA_NATIVE_MONEY__NETWORK_EARN_TAXI_JOB);
		MONEY.set_function("_NETWORK_EARN_DAILY_STASH_HOUSE_COMPLETED", LUA_NATIVE_MONEY__NETWORK_EARN_DAILY_STASH_HOUSE_COMPLETED);
		MONEY.set_function("_NETWORK_EARN_DAILY_STASH_HOUSE_PARTICIPATION", LUA_NATIVE_MONEY__NETWORK_EARN_DAILY_STASH_HOUSE_PARTICIPATION);
		...
		NETWORK.set_function("_NETWORK_GET_RANDOM_FLOAT_RANGED", LUA_NATIVE_NETWORK__NETWORK_GET_RANDOM_FLOAT_RANGED);
		...
		NETWORK.set_function("TRIGGER_PLAYER_CRC_HACKER_CHECK", LUA_NATIVE_NETWORK_TRIGGER_PLAYER_CRC_HACKER_CHECK);
		NETWORK.set_function("TRIGGER_TUNING_CRC_HACKER_CHECK", LUA_NATIVE_NETWORK_TRIGGER_TUNING_CRC_HACKER_CHECK);
		NETWORK.set_function("TRIGGER_FILE_CRC_HACKER_CHECK", LUA_NATIVE_NETWORK_TRIGGER_FILE_CRC_HACKER_CHECK);
		...
		STATS.set_function("_PLAYSTATS_SHOPMENU_NAV", LUA_NATIVE_STATS__PLAYSTATS_SHOPMENU_NAV);
		...
		STATS.set_function("_PLAYSTATS_ACID_MISSION_END", LUA_NATIVE_STATS__PLAYSTATS_ACID_MISSION_END);
		STATS.set_function("_PLAYSTATS_ACID_RND", LUA_NATIVE_STATS__PLAYSTATS_ACID_RND);
		STATS.set_function("_PLAYSTATS_IDLE", LUA_NATIVE_STATS__PLAYSTATS_IDLE);
		STATS.set_function("_PLAYSTATS_PLAYER_STYLE", LUA_NATIVE_STATS__PLAYSTATS_PLAYER_STYLE);
		...
		VEHICLE.set_function("_0x85FC953F6C6CBDE1", LUA_NATIVE_VEHICLE__0x85FC953F6C6CBDE1);
		...
		VEHICLE.set_function("_GET_VEHICLE_TRAILER_PARENT_VEHICLE", LUA_NATIVE_VEHICLE__GET_VEHICLE_TRAILER_PARENT_VEHICLE);
