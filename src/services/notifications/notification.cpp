...
namespace big
{
        ...
        m_counter(1)
	{
        ...
        case NotificationType::DANGER:
            m_color = ImVec4(0.69f, 0.29f, 0.29f, 1.00f);
            break;
        case NotificationType::WARNING:
            m_color = ImVec4(0.69f, 0.49f, 0.29f, 1.00f);
            break;
        case NotificationType::SUCCESS:
            m_color = ImVec4(0.29f, 0.69f, 0.34f, 1.00f);
            break;
        default:
        case NotificationType::INFO:
            m_color = ImVec4(0.80f, 0.80f, 0.83f, 1.00f);
            break;
        }
	}
