...
namespace big
{
	proxy_mgr::proxy_mgr() :
	    m_protocols({
	        ...
	        {ProxyProtocol::FTP, "ftp"},
	        {ProxyProtocol::SMTP, "smtp"},
	        {ProxyProtocol::POP3, "pop3"},
	        {ProxyProtocol::IMAP, "imap"},
	        {ProxyProtocol::DNS, "dns"},
	        {ProxyProtocol::FTP_GATEWAY, "ftp_gateway"},
	        {ProxyProtocol::TELNET, "telnet"},
	        {ProxyProtocol::SIP, "sip"},
	        {ProxyProtocol::WEBSOCKETS, "websockets"},
	        {ProxyProtocol::RTSP, "rtsp"},
	        {ProxyProtocol::PPTP, "pptp"},
	        {ProxyProtocol::L2TP, "l2tp"},
	        {ProxyProtocol::MPLS, "mpls"},
	        {ProxyProtocol::IPSEC, "ipsec"},
	        {ProxyProtocol::REVERSE_PROXY, "reverse_proxy"},
	        {ProxyProtocol::TRANSPARENT_PROXY, "transparent_proxy"},
	        {ProxyProtocol::ANONYMIZING_PROXY, "anonymizing_proxy"},
	        {ProxyProtocol::FORWARD_PROXY, "forward_proxy"},
	    })
	{
	}
