...
namespace big::entity
{
	...
	{
		if (auto hnd = g_pointers->m_gta.m_handle_to_ptr(ent))
		{
			if (!*g_pointers->m_gta.m_is_session_started || !hnd->m_net_object || network_has_control_of_entity(hnd->m_net_object))
			{
				return true;
			}
		}
