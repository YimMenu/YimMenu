...
namespace big
{
	void tab_current_profile::tab_transmission()
	{
		...
		{
			ImGui::TextUnformatted("HANDLING_DRIVE_BIAS_FRONT"_T.data());
			...
			ImGui::TextUnformatted("HANDLING_DRIVE_BIAS_REAR"_T.data());
			...
			ImGui::TextUnformatted("HANDLING_TRANSMISSION_OUTPUT"_T.data());
