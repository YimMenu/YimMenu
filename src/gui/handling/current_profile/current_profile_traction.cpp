...
namespace big
{
	void tab_current_profile::tab_traction()
	{
		if (ImGui::BeginTabItem("HANDLING_TAB_TRACTION"_T.data()))
		{
			...
			ImGui::TextUnformatted("HANDLING_TRACTION_BIAS"_T.data());
			...
			ImGui::TextUnformatted("HANDLING_OFF_ROAD_LOSS"_T.data());
