...
namespace big
{
	...
	public:
		...
		static bool button(const std::string_view, const ImVec2& size = ImVec2(0, 0), const ImVec4& color = ImVec4(0.24f, 0.23f, 0.29f, 1.00f));
		...
		static void button(const std::string_view, std::function<void()>, const ImVec2& size = ImVec2(0, 0), const ImVec4& color = ImVec4(0.24f, 0.23f, 0.29f, 1.00f));
