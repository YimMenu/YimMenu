...
namespace big
{
	...
	public:
		...
		struct protections
		{
			...
			std::vector<std::string> ip_block_list = {};

			NLOHMANN_DEFINE_TYPE_INTRUSIVE(protections, script_events, rid_join, lessen_breakups, desync_kick, receive_pickup, admin_check, ip_block_list)
		} protections{};
