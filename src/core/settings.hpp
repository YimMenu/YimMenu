...
namespace big
{
	...
	public:
		...
		struct vehicle
		{
			...
			bool modify_vehicle_ability                 = false;
			bool ability_jump                           = false;
			bool ability_rocket                         = false;
			bool ability_parachute                      = false;
			bool ability_ramp                           = false;
