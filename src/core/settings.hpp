		...
		*/
		...
		struct window
		{
			...
			struct ingame_overlay_indicators
			{
				...
				NLOHMANN_DEFINE_TYPE_INTRUSIVE(ingame_overlay_indicators, show_player_godmode, show_off_radar, show_vehicle_godmode, show_never_wanted, show_infinite_ammo, show_infinite_mag, show_aimbot, show_triggerbot, show_invisibility)
