...
const ipl_libary ipls[] = {
    ...
    },
    {
        "Cargoship", 
        { -162.89, -2365.76, 0.0 },
        {{"ship_occ_grp1"}, {"ship_occ_grp2"}, {"cargoship"}, {"sunk_ship_fire"}, {"sunkcargoship"}}
    },
    {
        "Destroyed Pillbox Hospital", 
        { 356.8, -590.1, 43.3 },
        {{"rc12b_default"}, {"rc12b_destroyed"}, {"rc12b_fixed"}, {"rc12b_hospitalinterior"}}
    },
    {
        "ONeil Farm", 
        { 2441.2, 4968.5, 51.7 },
        {{"des_farmhouse"}, {"des_farmhs_endimap"}, {"des_farmhs_startimap"}, {"farm"}, {"farm_burnt"}, {"farm_burnt_props"}, {"farm_props"}, {"farmint"}, {"farmint_cap"}, {"des_farmhs_end_occl"}, {"des_farmhs_start_occl"}}
    },
    {
        "Live Invader", 
        { -1047.9, -233.0, 39.0 },
        {{"facelobby"}, {"facelobbyfake"}}
    },
    {
        "Jewelry Store", 
        { -630.4, -236.7, 40.0 },
    ...
    },
    {
        "Coroner Morgue", 
        { 244.9, -1374.7, 39.5 },
        {{"coroner_int_off"}, {"coroner_int_on"}, {"coronertrash"}}
    }
};
