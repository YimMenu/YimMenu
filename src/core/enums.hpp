...
namespace big
{
	...
	{
		PED_TYPE_PLAYER_0              = 0,
		PED_TYPE_PLAYER_1              = 1 << 0,
		PED_TYPE_NETWORK_PLAYER        = 1 << 1,
		PED_TYPE_PLAYER_2              = 1 << 2,
		PED_TYPE_CIVMALE               = 1 << 3,
		PED_TYPE_CIVFEMALE             = 1 << 4,
		PED_TYPE_COP                   = 1 << 5,
		PED_TYPE_GANG_ALBANIAN         = 1 << 6,
		PED_TYPE_GANG_BIKER_1          = 1 << 7,
		PED_TYPE_GANG_BIKER_2          = 1 << 8,
		PED_TYPE_GANG_ITALIAN          = 1 << 9,
		PED_TYPE_GANG_RUSSIAN          = 1 << 10,
		PED_TYPE_GANG_RUSSIAN_2        = 1 << 11,
		PED_TYPE_GANG_IRISH            = 1 << 12,
		PED_TYPE_GANG_JAMAICAN         = 1 << 13,
		PED_TYPE_GANG_AFRICAN_AMERICAN = 1 << 14,
		PED_TYPE_GANG_KOREAN           = 1 << 15,
		PED_TYPE_GANG_CHINESE_JAPANESE = 1 << 16,
		PED_TYPE_GANG_PUERTO_RICAN     = 1 << 17,
		PED_TYPE_DEALER                = 1 << 18,
		PED_TYPE_MEDIC                 = 1 << 19,
		PED_TYPE_FIREMAN               = 1 << 20,
		PED_TYPE_CRIMINAL              = 1 << 21,
		PED_TYPE_BUM                   = 1 << 22,
		PED_TYPE_PROSTITUTE            = 1 << 23,
		PED_TYPE_SPECIAL               = 1 << 24,
		PED_TYPE_MISSION               = 1 << 25,
		PED_TYPE_SWAT                  = 1 << 26,
		PED_TYPE_ANIMAL                = 1 << 27,
		PED_TYPE_ARMY                  = 1 << 28,
	};
