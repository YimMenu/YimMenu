...
Read the [SETUP](docs/SETUP.md) guide.
...
If this is not the case for some reason you'll have to redo the steps in the [Making changes to the source code section of the SETUP](docs/SETUP.md#making-changes-to-the-source-code).
