...
namespace big
{
	void view::active_view() {
		...
		ImGui::SetNextWindowPos({ ((float)*g_pointers->m_resolution_x / 2554.f) * 250.f + 20.f, 100.f }, ImGuiCond_Always);
		ImGui::SetNextWindowSize({ (float)*g_pointers->m_resolution_x * 0.3f, 0.f }, ImGuiCond_Always);
