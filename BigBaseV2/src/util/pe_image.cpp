...
namespace utility {
	...
	uint64_t pe_image::GetDirectoryAddress(int index) {
	...
	uint64_t pe_image::RVAToVA(uint32_t rva) const {
	...
	bool pe_image::IsOpenVHookCompatible() {
	...
	bool pe_image::PatchCompatibility() {
